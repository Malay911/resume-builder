...
const TemplateSelector = ({selectedTemplate,onChange}) => {
    ...
    const templates=[
        ...
        },
        {
            id:"modern",
            name:"Modern",
            preview:"Sleek design with stategic use of color and modern font choices"
        },
        {
            id:"minimal",
            name:"Minimal",
  ...
  return (
    <div className='relative'>
        <button onClick={()=>setIsOpen(!isOpen)} className='flex items-center gap-1 text-am text-blue-600 bg-gradient-to-br from-blue-50 to-blue-100 ring-blue-300 hover:ring transition-all px-3 py-2 rounded-lg'>
