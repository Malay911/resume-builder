  ...
  return (
    <div className='space-y-6'>
        <div className='flex items-center justify-between'>
            <div>
                <h3 className='flex item-center gap-2 text-lg gont-semibold text-gray-900'>Education</h3>
                <p className='text-sm text-gray-500'>Add your education details</p>
            </div>
            <button onClick={addEducation} className='flex items-center gap-2 text-sm text-green-700 px-3 py-1 bg-green-100 rounded-lg hover:bg-green-200 transition-colors'>
                ...
                {data.map((education, index)=>(
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        <div className='flex justify-between items-start'>
                            ...
                            <button onClick={()=>removeEducation(index)} className='text-red-500 hover:text-red-700 transtion-colors'>
                        ...
                        <div className='grid md:grid-cols-2 gap-3'>
                            ...
                            <input type="text" placeholder="Degree (e.g., Bachelor's, Master's)" className='px-3 py-2 text-sm' value={education.degree || ""} onChange={(e)=>updateEducation(index,"degree",e.target.value)} />
