    ...
    return (
        <div className="min-h-screen flex" style={{ background: 'var(--bg-body)' }}>
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col items-center justify-center p-12 bg-black">
                ...
                />
                {/* animated glow blobs */}
                <div className="absolute top-10 right-10 w-72 h-72 rounded-full animate-blob" style={{ background: 'linear-gradient(135deg, rgba(59,130,246,0.15), rgba(139,92,246,0.15))', filter: 'blur(80px)' }} />
                <div className="absolute bottom-10 left-10 w-56 h-56 rounded-full animate-blob" style={{ background: 'linear-gradient(135deg, rgba(139,92,246,0.12), rgba(236,72,153,0.10))', filter: 'blur(70px)', animationDelay: '-4s' }} />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full" style={{ background: 'radial-gradient(circle, rgba(59,130,246,0.06) 0%, transparent 70%)' }} />

                <div className="relative text-center max-w-md z-10">
                    <Link to="/" className="mb-8 block">
                        <img src={logoWhite} alt="ResumeForge" className="h-9 w-auto mx-auto" />
                    </Link>
